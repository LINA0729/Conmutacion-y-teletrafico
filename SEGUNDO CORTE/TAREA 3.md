...
* **Cisco Packet Tracer:** Utilizado para el diseño, simulación y validación de todas las topologías y esquemas de direccionamiento descritos.
* **Escrutinio Técnico:** Aunque los protocolos base como ARP son vulnerables por diseño (**ARP Spoofing**), las configuraciones de seguridad en el **IOS** permiten mitigar riesgos operativos mediante prácticas de endurecimiento administrativo.
